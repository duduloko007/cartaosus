     ...
     <form  method="Post">
      <div class="col-md-6">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="permissions" ><br><br>

          <label>Permissões</label><br>
          <?php foreach ($permissions_list as $key => $value) {
            ?>
            <div class="form-check">
              <input type="checkbox" class="form-check-input" id="p_<?php echo $value['id']?>" name="permissions_group[]" value="<?php echo $value['id']?>" >
